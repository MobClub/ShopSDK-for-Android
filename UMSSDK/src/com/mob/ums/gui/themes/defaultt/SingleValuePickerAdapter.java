...
import com.mob.ums.gui.themes.defaultt.components.FlywheelView;
import com.mob.ums.gui.themes.defaultt.components.FlywheelView.OnSelectedListener;

import java.util.ArrayList;

public class SingleValuePickerAdapter extends ScrollUpAndDownDialogAdapter<SingleValuePicker>
		implements OnSelectedListener, OnClickListener {
	...
	protected void initBodyView(LinearLayout llBody) {
		...
		tvConfirm.setText(ResHelper.getStringRes(context, "umssdk_default_confirm"));
