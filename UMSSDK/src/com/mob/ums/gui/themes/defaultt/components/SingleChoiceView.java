...
import com.mob.ums.datatype.Area.Australia;
import com.mob.ums.datatype.Area.China;
import com.mob.ums.datatype.Area.France;
import com.mob.ums.datatype.Area.Germany;
import com.mob.ums.datatype.Area.India;
import com.mob.ums.datatype.Area.Japan;
import com.mob.ums.datatype.Area.Russia;
import com.mob.ums.datatype.Area.USA;
import com.mob.ums.datatype.Area.UnitedKingdom;
...
import com.mob.ums.gui.pickers.SingleValuePicker.OnSelectedListener;
...
public class SingleChoiceView extends LinearLayout {
	...
	private void init(Context context) {
		...
		tvChoice.setText(ResHelper.getStringRes(context, "umssdk_default_unedit"));
	...
	public static <T extends EnumType> ArrayList<Choice> createChoice(Class<T> type) {
		...
		if (type.equals(Country.class)) {
			Country[] moveTotop = {
					China.INSTANCE, USA.INSTANCE, Japan.INSTANCE,
					Russia.INSTANCE, UnitedKingdom.INSTANCE, France.INSTANCE,
					Germany.INSTANCE, India.INSTANCE, Australia.INSTANCE };
