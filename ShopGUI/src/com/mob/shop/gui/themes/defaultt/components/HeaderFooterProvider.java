		...
		if (llHeader == null) {
			llHeader = new HeaderFooterView(context) {
				protected String getPullArrowResName() {
					switch (style) {
						case WHITE: return "shopsdk_default_ptr_arr_d_white";
						default: return "shopsdk_default_ptr_arr_d";
					}
				}

				protected String getReleaseArrowResName() {
					switch (style) {
						case WHITE: return "shopsdk_default_ptr_arr_u_white";
						default: return "shopsdk_default_ptr_arr_u";
					}
				}
