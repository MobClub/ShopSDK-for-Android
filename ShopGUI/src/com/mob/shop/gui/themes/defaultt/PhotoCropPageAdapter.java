...
public class PhotoCropPageAdapter extends DefaultThemePageAdapter<PhotoCropPage> {
	...
	private void initPage(Activity activity) {
		...
		tv.setText(ResHelper.getStringRes(activity, "shopsdk_default_repick"));
		...
		tv.setText(ResHelper.getStringRes(activity, "shopsdk_default_use_this_picture"));
		tv.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				saveImage();
			}
					...
					UIHandler.sendMessage(msg, new Callback() {
						public boolean handleMessage(Message msg) {
							...
							if (bitmap == null || bitmap.isRecycled()) {
								...
								int resId = ResHelper.getStringRes(cxt, "shopsdk_default_pick_image");
								builder.setTitle(cxt.getString(resId));
								resId = ResHelper.getStringRes(cxt, "shopsdk_default_pick_image_failed");
				...
				try {
					...
					UIHandler.sendEmptyMessage(0, new Callback() {
						public boolean handleMessage(Message msg) {
							...
							int resId = ResHelper.getStringRes(cxt, "shopsdk_default_pick_image");
							builder.setTitle(cxt.getString(resId));
							resId = ResHelper.getStringRes(cxt, "shopsdk_default_save_image_failed");
							builder.setMessage(cxt.getString(resId));
