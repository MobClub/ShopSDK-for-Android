...
public class ScrollUpAndDownDialogAdapter<D extends Dialog<D>> extends DialogAdapter<D> {
	...
	private void initAnimations() {
		scrollUpAnim = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, 0, Animation
				.RELATIVE_TO_SELF, 1, Animation.RELATIVE_TO_SELF, 0);
		scrollUpAnim.setDuration(500);

		scrollDownAnim = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, 0,
