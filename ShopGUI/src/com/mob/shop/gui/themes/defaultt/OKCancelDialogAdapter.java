...
public class OKCancelDialogAdapter extends DefaultDialogAdapter<OKCancelDialog> {
	...
	public void init(final OKCancelDialog dialog) {
		...
		containLayout.setPadding(0,dp18,0,0);
		...
		tvMessage.setMinHeight(ResHelper.dipToPx(context, 40));
		...
		tvOK.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
		tvOK.setTextColor(0xfff6573b);
